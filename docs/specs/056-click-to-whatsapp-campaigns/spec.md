...
**Estado:** `BORRADOR` — cuarta pieza del programa SPEC-052; v0.2: la atribución pasa a la oportunidad (SPEC-061) y el embudo se abre por cliente nuevo/existente (12/09/2026)
