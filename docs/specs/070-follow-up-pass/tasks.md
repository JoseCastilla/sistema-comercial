...
- [x] Recorrido en producción y diez propuestas; José: «avanza con todo en
      ese orden, el grupo 5 con 7 días» (25/09/2026).
- [x] Reglas puras con pruebas (`recovery-follow-up-stale.test.mjs` 4 de 4).
- [x] Grupos 1 a 4: tarjetas, línea de cifras, por asesor, «Sin tocar
