...
**Estado:** `BORRADOR` — propuesta de José revisada contra el código el 08/09/2026; decisiones abiertas resueltas con recomendación, pendientes de su confirmación
