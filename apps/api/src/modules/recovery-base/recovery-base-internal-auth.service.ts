...
export interface RecoveryBaseInternalAuthorization {
...
@Injectable()
export class RecoveryBaseInternalAuthService {
  constructor(private readonly databaseService: DatabaseService) {}

  async authorize(input: RecoveryBaseInternalAuthorization): Promise<void> {
    ...
    const expected = signRecoveryBaseRequest(
      {
...
export function signRecoveryBaseRequest(
  input: {
    organizationId: string;
    actorUserId: string;
    timestamp: string;
...
export function getRecoveryBaseInternalSecret(): string {
