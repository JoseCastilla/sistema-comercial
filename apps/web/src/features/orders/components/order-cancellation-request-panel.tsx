...
export function OrderCancellationRequestPanel({
  ...
  return (
    <section className="rounded-xl border border-ui-warning-border bg-ui-warning-soft p-4">
      ...
      <p className="mt-3 text-sm leading-6 text-ui-warning">{request.reason}</p>
      ...
      {canReview ? (
        ...
        >
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <label className="space-y-1.5 text-sm">
              <span className="font-medium text-ui-warning">Decisión</span>
              <select
                className="w-full rounded-lg border border-ui-warning-border bg-ui-surface px-3 py-2 text-ui-text"
                disabled={pending}
                name="decision"
            ...
            {rejecting ? (
              <label className="space-y-1.5 text-sm">
                <span className="font-medium text-ui-warning">
                  Motivo del rechazo
                </span>
                <textarea
                  className="min-h-20 w-full rounded-lg border border-ui-warning-border bg-ui-surface px-3 py-2 text-ui-text"
                  disabled={pending}
                  maxLength={2000}
                  minLength={10}
                  name="observation"
          ...
          <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
            ...
            <button
              className="rounded-lg bg-ui-warning px-4 py-2 text-sm font-semibold text-ui-on-warning disabled:cursor-not-allowed disabled:opacity-50"
        ...
        <p className="mt-3 text-sm text-ui-warning">
