...
export function CopyValue({
  ...
  return (
    <button
      className="inline-flex cursor-pointer items-center gap-1 rounded-md border border-transparent px-1 py-0.5 font-mono text-xs text-ui-text hover:border-ui-border-strong hover:bg-ui-surface-muted focus:outline-none focus-visible:ring-2 focus-visible:ring-ui-accent"
      onClick={copy}
