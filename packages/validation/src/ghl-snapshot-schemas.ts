...
const businessDateSchema = z.union([
  ...
  z.string().regex(
    /^\d{4}-\d{2}-\d{2}$/,
    'La fecha comercial debe usar YYYY-MM-DD',
  ),
]);

export const attributionSnapshotSchema:
  z.ZodType<AttributionSnapshot> = z
    .object({
...
export const contactSnapshotSchema:
  z.ZodType<ContactSnapshot> = z
    .object({
...
export const ownerSnapshotSchema:
  z.ZodType<OwnerSnapshot> = z
    .object({
...
export const snapshotDatesSchema:
  z.ZodType<SnapshotDates> = z
    .object({
...
export const ghlContactSnapshotV2Schema:
  z.ZodType<GhlContactSnapshotV2> = z
    .object({
...
export const ghlCommercialCaseSnapshotV2Schema:
  z.ZodType<GhlCommercialCaseSnapshotV2> = z
    .object({
      schema_version: z.literal('2.0'),
      snapshot_type: z.literal(
        'commercial_case',
      ),
      ...
      commercial_case:
        commercialCaseFieldsSchema.extend({
...
export const legacyGhlSnapshotV1Schema:
  z.ZodType<LegacyGhlContactCommercialSnapshotV1> =
  z
    .object({
...
export const ghlIncomingSnapshotSchema:
  z.ZodType<GhlIncomingSnapshot> = z.union([
    ghlContactSnapshotV2Schema,
    ghlCommercialCaseSnapshotV2Schema,
    legacyGhlSnapshotV1Schema,
  ]);

export function parseGhlIncomingSnapshot(
  value: unknown,
): GhlIncomingSnapshot {
  return ghlIncomingSnapshotSchema.parse(value);
}

export function safeParseGhlIncomingSnapshot(
  value: unknown,
) {
